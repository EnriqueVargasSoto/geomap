...
<div class="content-wrapper">
    <section class="content">
		<div class="box box-success">
            ...
            <div class="box-body">
                <div class="row">                    
					<div class="col-md-offset-1 col-md-10 " id="graficoBarras">
			...
			tableVendedores = $('#tableVendedores').DataTable( {
				...
				"rowCallback": function( row, data, index ) {
				  ...
				  if (data.CoberturaMultiple < 50) { 
					$('td:nth-child(11)', row).css(styleRed);
				  }else if(data.CoberturaMultiple >= 50 && data.CoberturaMultiple < 80 ){
					$('td:nth-child(11)', row).css('background-color', 'orange');  
				  }else{
					$('td:nth-child(11)', row).css(styleGreen);   
				  }
				  // HitRate
				  if (data.hitrate < 50) { 
					$('td:nth-child(15)', row).css(styleRed);
				  }else if(data.hitrate >= 50 && data.hitrate < 80 ){
					$('td:nth-child(15)', row).css('background-color', 'orange');  
				  }else{
					$('td:nth-child(15)', row).css(styleGreen);   
				  }
				  //18
				  var faltanteVenta = ( parseFloat(data.PromVentaMesAnterior)  - parseFloat( data.ventaDia ) ).toFixed(2);
				  if (faltanteVenta > 50) { 
					$('td:nth-child(18)', row).css(styleRed);
				  }else if(faltanteVenta <= 50 && faltanteVenta > 3 ){
					$('td:nth-child(18)', row).css('background-color', 'orange');  
				  }else{
					$('td:nth-child(18)', row).css(styleGreen);   
				  }
				  //26
				  ...
				  if (data.avanceMes < 50) { 
					$('td:nth-child(27)', row).css(styleRed);
				  }else if(data.avanceMes >= 50 && data.avanceMes < 80 ){
					$('td:nth-child(27)', row).css('background-color', 'orange');  
				  }else{
					$('td:nth-child(27)', row).css(styleGreen);   
				  }
				}
			});
