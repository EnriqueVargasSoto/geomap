                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-8">
						...
						<div class="btn-group"> 									
						    ...
						    <button id="btnActualizarGuias" type="button" class="btn btn-danger btn-sm"><i class="fa fa-fw fa-lock"></i>  Cerrar día</button>
						</div>
						<!-- Check all button -->
...
@section('script')
    ...
    <script>
		...
		$(document).ready(function() {
				...
				$.ajax({
					...
					success: function(jsondata){
						...
						$.each(jsondata, function(index, element) {
							select.append("<option value='"+ element['idZona'] +"'>" + element['idZona'].toLowerCase() + "</option>");							
						}); 
			...
			function sc_obtenerRutas() {
				...
				.done(function(jsondata) {
					...
					$.each(jsondata, function(index, element){
						select.append("<option value='"+ element['idRuta'] +"'>" + element['idRuta'] + "</option>"); 
					}); 
					select.prop( "disabled", false ); 
					$("#overlay").addClass("hidden"); 
				})
		...
		function fc_sincronizarDataVendedor(idVendedor){
