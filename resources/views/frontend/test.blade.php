...
<div class="content-wrapper">
	...
	<div class="content mapita" id= "mapa"></div>
 </div>
...
@section('script')
    ...
    <script>
		...
		$(document).ready(function(){
			$("#mapa").css('min-height', $(window).height() - 190);
					...
					$.each(jsondata, function(index, pedido) {
						...
						if(datosClientes[numCliente]){ 
							if(datosClientes[numCliente].existePedido){
								...
								console.log("Nuevo pedido cliente"+pedido);
								...
								console.log("quitar marker cliente??"+datosClientes[numCliente].markerCliente);
								...
								console.log("cliente "+numCliente+"   pedido"+datosClientes[numCliente].markerCliente);
