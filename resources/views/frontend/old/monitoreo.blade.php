            ...
            <div class="col-xs-12">
				<div class="nav-tabs-custom">
					<ul class="nav nav-tabs">
					  <li class="active"><a  id="minAutoventa" href="#tab_1" data-toggle="tab" aria-expanded="false" style="">Autoventa</a></li>
					  <li class=""><a id="minPreventa" href="#tab_2" data-toggle="tab" style="" aria-expanded="false">Preventa</a></li>
					  <li class=""><a id="minDespacho" href="#tab_3" data-toggle="tab" style="" aria-expanded="true">Despacho</a></li>					  
					</ul>
                        ...
                        "render": function ( data, type, row, meta ) {
                            ...
                            if(count == 0 || row.clientesConPedidos <= 0 ){
                               return "";
								...
								return '<div class="btn-group"> <a href="javascript:void(0)" class="btn btn-default btn-xs" onClick="fc_openDetalle(\''+row.nombrex+'\',\''+row.vendedorx+'\',\''+row.zona+'\',\''+row.ruta+'\',\''+row.numeroGuiax+'\',\'Preventa\','+row.clientesProgramados+')"><i class="fa fa-fw fa-eye"></i></a>'+
                        ...
                        "render": function ( data, type, row, meta ) {
                            ...
                            if(count == 0){
								...
								if(row.clientesProgramados > 0){
									return '<a href="javascript:void(0)" onClick="fc_mostrarClientes(\''+row.nombrex+'\',\''+row.vendedorx+'\',\''+row.zona+'\')">'+row.clientesProgramados+'</a>';
								}else{
									return '0';
								}
                            }
                            ...
                            var count = Object.keys(row).length;
                             ...
                             if(count == 0 || row.clientesConPedidos <= 0 ){
                               return "";
								...
								return '<div class="btn-group"> <a href="javascript:void(0)" class="btn btn-default btn-xs" onClick="fc_openDetalle(\''+row.nombrex+'\',\''+row.vendedorx+'\',\''+row.zona+'\',\'all\',\''+row.numeroGuiax+'\',\'Autoventa\','+row.clientesProgramados+')"><i class="fa fa-fw fa-eye"></i></a>'+									
                        ...
                        "render": function ( data, type, row, meta ) {
                            ...
                            if(count == 0 || row.clientesConPedidos <= 0 ){ 
                               return "";
								...
								return '<div class="btn-group"> <a href="javascript:void(0)" class="btn btn-default btn-xs" onClick="fc_openDetalle(\''+row.nombrex+'\',\''+row.vendedorx+'\',\''+row.zona+'\',\'all\',\''+row.numeroGuiax+'\',\'Despacho\','+row.clientesProgramados+')"><i class="fa fa-fw fa-eye"></i></a>'+
