...
<div class="content-wrapper">
    <section class="content-header">
        <h1> NUEVA ENCUESTA<small>encuesta, vigencia, filtros encuesta </small> </h1>
    </section>
    <section class="content">
        {!! Form::open(['url' => url('/encuesta/nueva'), 'id' => 'formEncuesta', 'enctype' => 'multipart/form-data']) !!}
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                {!! $errors->first('descripcion', '<div class="text-red">:message</div>') !!}
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                ?>
                                <label>Tipo:</label>
                                {!! Form::select('tipoEncuesta',$tipoEncuesta, null, ['class'=> 'form-control select2','tabindex' => 1, 'id' => 'tipoEncuesta']) !!}
                                {!! $errors->first('tipoEncuesta', '<div class="text-red">:message</div>') !!}
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="form-group">
                    ...
                    <h4>Asociacion de Encuesta</h4><hr>
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="form-group">
                                <?php
                                ...
                                {!! Form::select('ocasionConsumo[]',$ocasionConsumo, null, ['class'=> 'form-control select2','multiple'=> true,'tabindex' => 1, 'id' => 'ocasionConsumo']) !!}
                                <div class="text-red">
                                    @foreach ($errors->get('ocasionConsumo') as $error)
                                    {{ $error }}</br>
                                    @endforeach
                                </div>
                            </div>
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                {!! Form::select('canalVentas[]',$canalVentas, null, ['class'=> 'form-control select2','multiple'=> true,'tabindex' => 1, 'id' => 'canalVentas']) !!}
                                <div class="text-red">
                                    @foreach ($errors->get('canalVentas') as $error)
                                    {{ $error }}</br>
                                    @endforeach
                                </div>
                            </div>
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                ?>
                                <label>Giro:</label><br>
                                {!! Form::select('giro[]',$giro, null, ['class'=> 'form-control select2','multiple'=> true,'tabindex' => 1, 'id' => 'giro']) !!}
                                <div class="text-red">
                                    @foreach ($errors->get('giro') as $error)
                                    {{ $error }}</br>
                                    @endforeach
                                </div>
                            </div>
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <div class="text-red">
                                    @foreach ($errors->get('subGiro') as $error)
                                    {{ $error }}</br>
                                    @endforeach
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            <div class="col-sm-5">
                                ...
                                <div class="text-red">
                                    @foreach ($errors->get('filtroVendedor') as $error)
                                    {{ $error }}</br>
                                    @endforeach
                                </div>
                            </div>
                            ...
                            <div class="col-sm-5">
                                ...
                                <div class="text-red">
                                    @foreach ($errors->get('filtroVendedor_to') as $error)
                                    {{ $error }}</br>
                                    @endforeach
                                </div>
                            </div>
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="col-sm-5">
                                ...
                                <div class="text-red">
                                    @foreach ($errors->get('filtroRoles_to') as $error)
                                    {{ $error }}</br>
                                    @endforeach
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            <div class="col-sm-5">
                                ...
                                <div class="text-red">
                                    @foreach ($errors->get('filtroSegmentos_to') as $error)
                                    {{ $error }}</br>
                                    @endforeach
                                </div>
                            </div>
                ...
                <div class="box-footer">
                    ...
                    <button id="btnLimpiarEncuesta" type="button" class="btn btn-default"> Limpiar </button>
                </div>
            </div>
        {!! Form::close() !!}
    </section>
