...
class MonitoreoController extends Controller
{
     ...
     * Api....
    */ 
	public function obtenerResumenMarca(Request $request){
		//dd(Auth::user()->idSucursal);
		...
		//try {
		//	\DB::enableQueryLog();
		//	$lista = DB::select("exec [web_obtenerResumenVentasxMarca_new] ?,?,?", [$idEmpresa, '01', $idVendedor]);
		//	dd(\DB::getQueryLog());
		//} catch (\Exception $e) {
		//	dd($e->getMessage());
		//}
